        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BrandName = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    HeadquartersLocation = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    ContactEmail = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    ContactPhone = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    FactionName = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    ManufacturerName = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    HeadquartersLocation = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    ContactEmail = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    ContactPhone = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    PropertyName = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    StateName = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    PaintLineName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    Description = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    MiniName = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    MiniDesc = table.Column<string>(type: "TEXT", nullable: false),
                    MiniFactionId = table.Column<Guid>(type: "TEXT", nullable: false),
                    MiniPropertiesId = table.Column<Guid>(type: "TEXT", nullable: false),
                    MiniManufacturerId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UPC = table.Column<string>(type: "TEXT", maxLength: 12, nullable: false),
                    BrandId = table.Column<Guid>(type: "TEXT", nullable: false),
                    PaintTypeId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MiniatureId = table.Column<Guid>(type: "TEXT", nullable: false),
                    MiniStateId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    UsageType = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    Notes = table.Column<string>(type: "TEXT", nullable: false),
                    MiniatureCollectionId = table.Column<Guid>(type: "TEXT", nullable: false),
                    UserPaintsId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
