...
{
    public BaseService(IBaseUOW serviceUOW, TDalRepository serviceRepository, IBLLMapper<TBllEntity, TDalEntity, Guid> bllMapper) 
        : base(serviceUOW, serviceRepository, bllMapper)
    {
    }
}
    ...
    where TKey : IEquatable<TKey>
{
    ...
    public virtual void Remove(TKey id, TKey? userId = default)
    {
        ...
        if (entity == null)
        {
            ServiceRepository.Remove(id, userId);
        }
    }
